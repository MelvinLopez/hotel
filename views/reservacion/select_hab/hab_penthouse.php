...
if($_SESSION['id_tusuario'] == 1) { 
                ...
                $habitacion = $t_usuario->gethabitacion();
                    ...
                    $hab_penthouse= $t_usuario->hab_penthouse();
...
<div class="card text-center">
    ...
    <label>Codigo de Habitación</label>       
            ...
            <select name="id_habitacion" class="form-control" required>
                <?php if(empty($hab_penthouse)){ ?>
                    <option value="0">No hay Habitaciones</option>
                <?php }else{ ?>    

                <?php foreach ($hab_penthouse as $fila) { ?>    
                ...
                <?php } } ?>
							  ...
							  <div class="form-group">
                               ...
                               <td><input type="reset" class="btn btn-warning" value="limpiar"></td>
                                    <td><input type="submit" class="btn btn-info" value="guardar"></td>
                                </div>						   
                        </div>
