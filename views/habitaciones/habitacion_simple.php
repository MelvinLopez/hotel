            ...
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    <li>
                        ...
                        <a href="../list_cuartos.php" >Atras</a>
                        
                        <a href="#" >Habitaciones Simples</a>
                        <a href="../habitaciones/habitacion_doble.php" >Habitaciones Doble</a>
                        <a href="../habitaciones/habitacion_lujosa.php" >Habitaciones Lujosas</a>
                        <a href="../habitaciones/habitacion_penthouse.php" >Penthouse</a>
                    </li>
				</ul>
            </div>
        </nav>
...
<div id="page-wrapper" >
    <div id="page-inner">
        <div class="row">
            <div class="col-md-12">
            <h4>Hola, Administrador <?= $usuario ?> </h4>
...
<table cellpadding="5" class="table table-striped">
                ...
                <tr>
                    ...
                    <th scope="col">Codigo </th>
                        ...
                        <th><a href="nueva_hab/nueva_simple.php"> Agregar Cuartos </a></th>
                    </tr>
                </thead>
                <tbody>
                    ...
                    <?php foreach ($stmt as $fila){ 
                        ...
                        <td>
<a onclick="return confirm('Esta seguro que quiere eliminar el registo')" href="../../controllers/usuario_controllers.php?action=eliminar_cuarto&id=<?= $fila[0] ?>" class= "btn btn-success">Eliminar</a>
