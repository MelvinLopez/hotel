            ...
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    <li>
                        ...
                        <a href="habitacion_doble.php" >Habitaciones Doble</a>
                        <a href="#" >Habitaciones Lujosas</a>
...
<table cellpadding="5" class="table table-striped">
                ...
                <tr>
                    ...
                    <th scope="col">Codigo </th>
                        ...
                        <th><a href="nueva_hab/nueva_lujosa.php"> Agregar Cuartos </a></th>
                    </tr>
                </thead>
                <tbody >
                    ...
                    <?php foreach ($stmt as $fila){ 
                        ...
                        <td>
<a onclick="return confirm('Esta seguro que quiere eliminar el registo con codigo de habitacion <?= $fila[0] ?>')" href="../../controllers/usuario_controllers.php?action=eliminar_cuarto3&id=<?= $fila[0] ?>" class= "btn btn-success">Eliminar</a>
