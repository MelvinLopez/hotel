                ...
                <div class="sidebar-collapse">
                    <ul class="nav" id="main-menu">
                        <li>
                            ...
                            <a href="../habitacion_doble.php" >Atrás</a>
                        </li>
                    </ul>
                </div>
            </nav>
...
<form action="../../../controllers/usuario_controllers.php?action=nuevaHabitacion2" method="post">
        ...
        <div class="form-group">
                    ...
                    <option > Dos Camas, Baño, Cocina, Televisión, Armario pequeño </option>
