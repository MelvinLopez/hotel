            ...
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    <li>
                        ...
                        <a href="../habitacion_simple.php" >Atrás</a>
                    </li>
				</ul>
            </div>
        </nav>
...
<form action="../../../controllers/usuario_controllers.php?action=nuevaHabitacion" method="post">
        ...
        <div class="form-group">
                    ...
                    <option > Cama, Baño, Cocina, Televisión, Armario pequeño </option>
