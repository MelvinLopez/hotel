        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    <li>
                        <a href="../habitacion_penthouse.php" >Atrás</a>
                    </li>
				</ul>
            </div>
        </nav>
...
<form action="../../../controllers/usuario_controllers.php?action=nuevaHabitacion4" method="post">
        ...
        <div class="form-group">
                    ...
                    <option > Una cama grande, Baño con tina y ducha, Cocina, Chimenea, Televisión, WIFI, Armario grande, Vista panorámica </option>
