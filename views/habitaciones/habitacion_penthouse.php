            ...
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    <li>
                        ...
                        <a href="habitacion_doble.php">Habitaciones Dobles</a>
...
<table cellpadding="5" class="table table-striped">
                ...
                <tr>
                    ...
                    <th scope="col">Codigo </th>
                        ...
                        <th><a href="nueva_hab/nueva_penthouse.php"> Agregar Cuartos </a></th>
                    </tr>
                </thead>
                <tbody>
                    ...
                    <?php foreach ($stmt as $fila){ 
                        ...
                        <td>
<a onclick="return confirm('Esta seguro que quiere eliminar el registo')" href="../../controllers/usuario_controllers.php?action=eliminar_cuarto4&id=<?= $fila[0] ?>" class= "btn btn-success">Eliminar</a>
