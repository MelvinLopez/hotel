            ...
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    <li>
                        ...
                        <a href="reservacion/reservation_views.php" >atras</a>
        ...
        <div class="row">
            ...
            <h4>Hola, Administrador <?= $usuario ?> </h4>
                <h1 class="page-header">
                    <small>Aprobar Solicitudes</small>
                </h1>                 
                 
<form action="../controllers/usuario_controllers.php?action=aprovar&id=<?= $_GET['id'] ?>"  method="post">    
<table class="table">
<thead>
    <tr>
